...
const slide = new Swiper('.swiper-container', {
	...
	keyboard: {
		...
		onlyInViewport: true,
		// вкл-выкл с помощью pageUp, pageDown
		pageUpDown: true,
	},
	...
	mousewheel: {
		// чувствительность
		sensitivity: 1,
		// класс объекта на котором срабатывает прокрутка мышью
	...
	// кол-во пролистываемых слайдеров
	sliderPerGroup: 1,
	...
	// ленивая загрузка (добавляем класс к img - swiper-lazy)
